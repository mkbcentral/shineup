...
<body>
    <div class="wrapper">
        @include('layouts.partials.navigation.topbar')
        @include('layouts.partials.navbar')
        @include('layouts.partials.navigation.carousel')
        {{ $slot }}
    ...
    <script src="{{ asset('assets/lib/lightbox/css/lightbox.min.css') }}"></script>
